        ...
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full bg-gradient-to-r from-purple-500 to-pink-500 text-white py-3 rounded-xl font-medium hover:shadow-lg hover:scale-[1.02] transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
            >
              {isLoading ? (
        ...
        <div className="relative z-10 text-white max-w-md">
          ...
          <div className="grid grid-cols-2 gap-6">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6">
              ...
              <div className="text-purple-100 text-sm">Emails/Minute</div>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6">
          ...
          <div className="mt-8 bg-white/10 backdrop-blur-sm rounded-2xl p-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-sm text-purple-100">Marketing Director at TechFlow</div>
              </div>
            </div>
          </div>
        </div>
