...
export default function Home() {
  return (
    <main className="min-h-screen">
      ...
      {/* ==========================
          12-Layer Deep Verification (MOVED TO TOP)
         ========================== */}
      <section className="py-12 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="bg-gradient-to-br from-teal-50 to-green-50 p-8 rounded-3xl hover:shadow-xl transition-shadow duration-300">
            <div className="w-16 h-16 bg-teal-500 rounded-2xl flex items-center justify-center mb-6 mx-auto">
              <span className="text-5xl">🧠</span>
            </div>
            <h3 className="text-5xl font-bold mb-4 text-center">12-Layer Deep Verification System</h3>
            ...
            <ul className="text-gray-700 grid md:grid-cols-3 leading-relaxed gap-y-3 gap-x-6 text-lg max-w-6xl mx-auto">
              <li className="flex items-start gap-3">
                <span className="mt-1 text-green-600">✅</span>
                <span>Syntax & formatting check</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="mt-1 text-green-600">✅</span>
              ...
              <li className="flex items-start gap-3">
                <span className="mt-1 text-green-600">✅</span>
                <span>SMTP live mailbox check</span>
              </li>
              ...
              <li className="flex items-start gap-3">
                <span className="mt-1 text-green-600">✅</span>
                <span>Role-based address filtering</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="mt-1 text-green-600">✅</span>
              ...
              <li className="flex items-start gap-3">
                <span className="mt-1 text-green-600">✅</span>
                <span>Spam-trap & honeypot screening</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="mt-1 text-green-600">✅</span>
                <span>Blacklist & abuse DB cross-check</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="mt-1 text-green-600">✅</span>
                <span>Typo & suggestion correction</span>
              </li>

              <li className="flex items-start gap-3">
                <span className="mt-1 text-green-600">✅</span>
                <span>Greylisting re-check handling</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="mt-1 text-green-600">✅</span>
                <span>Risk scoring & reputation lookup</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="mt-1 text-green-600">✅</span>
                <span>Deliverability confidence score</span>
              </li>
            </ul>
          </div>
        </div>
      ...
      {/* ==========================
          Main Features (6 cards) - shown after 12-layer
         ========================== */}
      <section id="features" className="py-16 px-6 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-10">
            <h2 className="text-4xl font-bold mb-2">A verifier like no other</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-cyan-50 p-8 rounded-3xl hover:shadow-xl transition-shadow duration-300">
              ...
              <p className="text-gray-600 leading-relaxed">Industry-leading accuracy on Gmail, Outlook, and all major providers.</p>
            </div>
            ...
            <div className="bg-gradient-to-br from-green-50 to-emerald-50 p-8 rounded-3xl hover:shadow-xl transition-shadow duration-300">
              ...
              <p className="text-gray-600 leading-relaxed">Pay as you go. No subscriptions. Credits never expire.</p>
            </div>
            ...
            <div className="bg-gradient-to-br from-orange-50 to-yellow-50 p-8 rounded-3xl hover:shadow-xl transition-shadow duration-300">
              ...
              <p className="text-gray-600 leading-relaxed">Your data is encrypted and automatically deleted after 30 days.</p>
            </div>
            ...
            <div className="bg-gradient-to-br from-pink-50 to-rose-50 p-8 rounded-3xl hover:shadow-xl transition-shadow duration-300">
              ...
              <p className="text-gray-600 leading-relaxed">Watch your verification progress live with instant CSV export.</p>
            </div>
            ...
            <div className="bg-gradient-to-br from-indigo-50 to-purple-50 p-8 rounded-3xl hover:shadow-xl transition-shadow duration-300">
              ...
              <p className="text-gray-600 leading-relaxed">Upload CSV → Verify → Download. That's it. No learning curve.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-6 bg-gradient-to-br from-purple-50 to-pink-50">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-5xl font-bold mb-4">Just three simple steps</h2>
            <p className="text-xl text-gray-600">No technical knowledge required. Start verifying in seconds.</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600 leading-relaxed">Drag and drop your email list. We'll automatically detect the format.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 leading-relaxed">We verify each email with SMTP, DNS, and syntax checks in real-time.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 leading-relaxed">Get your clean list instantly. Only valid emails, ready to send.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="pricing" className="py-24 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">Pay as you go. No subscriptions. No hidden fees. Credits never expire.</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
            ...
            <div className="bg-white border-2 border-gray-200 rounded-3xl p-8 hover:border-purple-300 hover:shadow-xl transition-all duration-300">
              ...
              <Link href="/register" className="block w-full bg-gray-100 text-center text-gray-700 py-3 rounded-full font-medium hover:bg-gray-200 transition-colors mb-6">
                Get started
              </Link>
            ...
            <div className="bg-gradient-to-br from-purple-500 to-pink-500 text-white rounded-3xl p-8 relative overflow-hidden shadow-2xl transform scale-105">
              <div className="absolute top-4 right-4 bg-white text-purple-600 px-3 py-1 rounded-full text-xs font-bold">POPULAR</div>
              <div className="mb-6">
              ...
              <Link href="/register" className="block w-full bg-white text-purple-600 text-center py-3 rounded-full font-medium hover:bg-purple-50 transition-colors mb-6">
                Get started
              </Link>
              <div className="space-y-3 text-sm">
                <div className="flex items-start gap-2">
            ...
            <div className="bg-white border-2 border-gray-200 rounded-3xl p-8 hover:border-purple-300 hover:shadow-xl transition-all duration-300">
              ...
              <Link href="/register" className="block w-full bg-gradient-to-r from-purple-500 to-pink-500 text-center text-white py-3 rounded-full font-medium hover:shadow-lg transition-all mb-6">
                Get started
              </Link>
              <div className="space-y-3 text-sm">
                <div className="flex items-start gap-2">
          ...
          <div className="text-center mt-12">
            <Link href="/pricing" className="inline-flex items-center gap-2 text-purple-600 hover:text-purple-700 font-medium">
      ...
      <section id="faq" className="py-24 px-6 bg-gray-50">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-5xl font-bold mb-4">Questions & answers</h2>
          </div>
          ...
          <div className="space-y-6">
            <details className="bg-white rounded-2xl p-6 hover:shadow-md transition-shadow cursor-pointer group">
              ...
              <p className="mt-4 text-gray-600 leading-relaxed">
                We achieve 97% accuracy on Gmail, Outlook, and all major email providers. We use multiple verification
                methods including SMTP, DNS, and syntax validation to ensure the highest accuracy.
              </p>
            </details>
            ...
            <details className="bg-white rounded-2xl p-6 hover:shadow-md transition-shadow cursor-pointer group">
              ...
              <p className="mt-4 text-gray-600 leading-relaxed">No! Your credits never expire. Buy once and use them whenever you need. No pressure, no subscriptions.</p>
            </details>
            ...
            <details className="bg-white rounded-2xl p-6 hover:shadow-md transition-shadow cursor-pointer group">
              ...
              <p className="mt-4 text-gray-600 leading-relaxed">Absolutely. All data is encrypted in transit and at rest. We automatically delete your uploaded files after 30 days. We never share your data with third parties.</p>
            </details>
            ...
            <details className="bg-white rounded-2xl p-6 hover:shadow-md transition-shadow cursor-pointer group">
              ...
              <p className="mt-4 text-gray-600 leading-relaxed">We process 2,500 emails per minute on average. A list of 100,000 emails typically takes around 40 minutes to complete.</p>
            </details>
            ...
            <details className="bg-white rounded-2xl p-6 hover:shadow-md transition-shadow cursor-pointer group">
              ...
              <p className="mt-4 text-gray-600 leading-relaxed">We support CSV and TXT files. Your file should have one email address per line or in a column.</p>
            </details>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-6">
        <div className="max-w-4xl mx-auto text-center bg-gradient-to-br from-purple-500 to-pink-500 rounded-3xl p-16 text-white">
          <h2 className="text-5xl font-bold mb-6">Ready to clean your lists?</h2>
          <p className="text-xl mb-10 opacity-90">Join thousands of marketers who trust OnlyValidEmails to keep their lists clean.</p>
          <Link href="/register" className="inline-block bg-white text-purple-600 px-8 py-4 rounded-full text-lg font-medium hover:shadow-2xl hover:scale-105 transition-all duration-200">
            Start verifying for free →
          </Link>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              ...
              <p className="text-gray-600 text-sm">The simplest way to verify email addresses.</p>
            </div>
            <div>
          ...
          <div className="pt-8 border-t border-gray-200 text-center text-sm text-gray-500">© 2025 OnlyValidEmails. All rights reserved.</div>
        </div>
      </footer>
    </main>
  );
